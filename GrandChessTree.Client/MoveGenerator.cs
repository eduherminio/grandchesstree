       ...
       public static Board[] PerftRoot(ref Board board, int depth, bool whiteToMove)
        {
            ...
            if (whiteToMove)
            {
                ...
                while (positions != 0)
                {
                    PerftWhitePawn(ref board, ref boards, ref moveIndex, depth, positions.PopLSB());
                }

                positions = board.WhiteKnight;
                while (positions != 0)
                {
                    PerftWhiteKnight(ref board, ref boards, ref moveIndex, depth, positions.PopLSB());
                }

                positions = board.WhiteBishop;
                while (positions != 0)
                {
                    PerftWhiteBishop(ref board, ref boards, ref moveIndex, depth, positions.PopLSB());
                }

                positions = board.WhiteRook;
                while (positions != 0)
                {
                    PerftWhiteRook(ref board, ref boards, ref moveIndex, depth, positions.PopLSB());
                }

                positions = board.WhiteQueen;
                while (positions != 0)
                {
                    PerftWhiteQueen(ref board, ref boards, ref moveIndex, depth, positions.PopLSB());
                }

                positions = board.WhiteKing;
                while (positions != 0)
                {
                    PerftWhiteKing(ref board, ref boards, ref moveIndex, depth, positions.PopLSB());
                }
            }
            else
            {
                ...
                while (positions != 0)
                {
                    PerftBlackPawn(ref board, ref boards, ref moveIndex, depth, positions.PopLSB());
                }

                positions = board.BlackKnight;
                while (positions != 0)
                {
                    PerftBlackKnight(ref board, ref boards, ref moveIndex, depth, positions.PopLSB());
                }

                positions = board.BlackBishop;
                while (positions != 0)
                {
                    PerftBlackBishop(ref board, ref boards, ref moveIndex, depth, positions.PopLSB());
                }

                positions = board.BlackRook;
                while (positions != 0)
                {
                    PerftBlackRook(ref board, ref boards, ref moveIndex, depth, positions.PopLSB());
                }

                positions = board.BlackQueen;
                while (positions != 0)
                {
                    PerftBlackQueen(ref board, ref boards, ref moveIndex, depth, positions.PopLSB());
                }

                positions = board.BlackKing;
                while (positions != 0)
                {
                    PerftBlackKing(ref board, ref boards, ref moveIndex, depth, positions.PopLSB());
                }
            }
        ...
        public static void PerftWhiteKnight(ref Board board, ref Span<Board> boards, ref int moveIndex, int depth, int index)
        {
            Board newBoard = default;
        ...
        public static void PerftWhiteBishop(ref Board board, ref Span<Board> boards, ref int moveIndex, int depth, int index)
        {
            Board newBoard = default;
        ...
        public static void PerftBlackKnight(ref Board board, ref Span<Board> boards, ref int moveIndex, int depth, int index)
        {
            Board newBoard = default;
        ...
        public static void PerftBlackBishop(ref Board board, ref Span<Board> boards, ref int moveIndex, int depth, int index)
        {
            Board newBoard = default;
