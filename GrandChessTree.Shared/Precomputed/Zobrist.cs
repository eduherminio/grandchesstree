...
public static unsafe class Zobrist
{
    ...
    public const int BlackPawn = 1 * 64;
    public const int BlackKnight = 3 * 64;
    public const int BlackBishop = 5 * 64;
    public const int BlackRook = 7 * 64;
    public const int BlackQueen = 9 * 64;
    public const int BlackKing = 11 * 64;
                 
    public const int WhitePawn = 2 * 64;
    public const int WhiteKnight = 4 * 64;
    public const int WhiteBishop = 6 * 64;
    public const int WhiteRook = 8 * 64;
    public const int WhiteQueen = 10 * 64;
    public const int WhiteKing = 12 * 64;
