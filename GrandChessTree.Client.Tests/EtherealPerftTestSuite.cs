    ...
    public class EtherealPerftTestSuite : PerftTestsBase
    {
        ...
        public static IEnumerable<object[]> GetTestData()
        {
            ...
            foreach (var position in positions)
            {
                ...
                // Return an array of objects with the FEN and D1-D6 values
                yield return new object[] { fen, dValues[0], dValues[1], dValues[2], dValues[3], dValues[4], dValues[5] };
            }
